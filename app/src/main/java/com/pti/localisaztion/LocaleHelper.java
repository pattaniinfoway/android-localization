...
/**
 * Created by Gautam on 15-03-2018.
 */
...
public class LocaleHelper {
    ...
    public static String getLanguageCode(Context mContext) {
       String code="";
        /*if (getLanguage(mContext).equals(Constant.ENGLISH)) {
            code="en";
        }else if (getLanguage(mContext).equals(Constant.BAHASA)){
            code="ms";
        }else if (getLanguage(mContext).equals(Constant.CHINESE)){
            code="cn";
        }*/
        return code;
    }
